#region << 版 本 注 释 >>
/*----------------------------------------------------------------
* 项目名称 ：UBIF.Framework.Data.Repository
* 项目描述 ：
* 类 名 称 ：RepositoryBase
* 类 描 述 ：
* 所在的域 ：DESKTOP-O4LCU7F
* 命名空间 ：UBIF.Framework.Data.Repository
* 机器名称 ：DESKTOP-O4LCU7F 
* CLR 版本 ：4.0.30319.42000
* 作    者 ：welus
* 创建时间 ：2019/5/17 11:23:23
* 更新时间 ：2019/5/17 11:23:23
* 版 本 号 ：v1.0.0.0
*******************************************************************
...
namespace UBIF.Framework.Data
{
    ...
    {
        public UbifBaseEntities dbcontext = new UbifBaseEntities();
